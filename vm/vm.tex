...
\fi
  ...
  \begin{frame}[fragile]
    ...
    \item{Command \textbf{VMMap.EXE $<$pid$>$} can be used to dump the user space layout of a Windows process} \pause
      \begin{itemize}
      \item{\emph{VMMap.EXE} can be found in the companion CD of the book \htmladdnormallink{\emph{Programming Applications for Microsoft Windows}}{http://www.microsoft.com/mspress/books/2345.aspx}.} \pause
      \end{itemize}
    \end{itemize}
    {\tiny
\begin{verbatim}
...
\fi
  ...
  \begin{frame}
    ...
    \begin{center}
      \includegraphics[scale=0.4]{linuxasl}
    \end{center}
  \end{frame}
