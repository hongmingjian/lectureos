...
\begin{CJK*}{UTF8}{song}
  ...
  \begin{frame}
    ...
    \item{Examples}
      \begin{itemize}
      \item{\textbf{NTLDR} - boot-loader for Windows NT/XP (resides in C:$\backslash$).} \pause
...
\iffalse
  ...
  \begin{frame}
    ...
    \begin{itemize}
    \item{When CPU is doing I/O with a peripheral device, two methods is available:} \pause
      \begin{itemize}
